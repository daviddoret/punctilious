...
.. seealso::
   :doc:`theory_elaboration_sequence`

Definition
----------

An *hypothesis* is a special statement, that branches out a child :doc:`theory_elaboration_sequence` from a parent :doc:`theory_elaboration_sequence`, and postulates a new :doc:`formula_statement` as true.
...
The simplest way to pose an hypothesis is to call the :python:`pose_hypothesis` method of the :doc:`theory_elaboration_sequence`:
