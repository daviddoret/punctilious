...
This sample python script showcase how to use the absorption inference-rule.

Usage
----------------------

The simplest way to use the absorption inference-rule is to access it via the :python:`inference_rules` (abridged :python:`i` ) property of the :ref:`theory_elaboration_sequence_math_concept`:
