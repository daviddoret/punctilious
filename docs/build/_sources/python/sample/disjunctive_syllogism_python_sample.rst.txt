.. _disjunctive_syllogism_python_sample:
...
.. code-block:: python
   ...
   ...
   t.i.disjunctive_syllogism.infer_statement(...)

Sample code
----------------------

.. literalinclude :: ../../../../src/sample/sample_disjunctive_syllogism.py
  :language: python
...
.. tabs::
   ...
   .. tab:: Unicode
      ...
      .. literalinclude :: ../../../../data/sample_disjunctive_syllogism_unicode.txt
         :language: text

   .. tab:: Plaintext

      .. literalinclude :: ../../../../data/sample_disjunctive_syllogism_plaintext.txt
         :language: text
