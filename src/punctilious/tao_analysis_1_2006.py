...
yaml_file_2 = _bundling.YamlFileBundle(path='data.representations',
                                       resource='tao_analysis_1_2006.yaml')
yaml_file_3 = _bundling.YamlFileBundle(path='data.mappings',
                                       resource='tao_analysis_1_2006.yaml')

successor: _formal_language.Connector = yaml_file_1.connectors.get_from_uuid(
