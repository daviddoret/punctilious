...
ts.register_styledstring(tag=pl1_ts.connective_negation, text="négation", treatment=treatment, flavor=flavor,
    language=language)
ts.register_styledstring(tag=pl1_ts.connective_material_implication, text="conditionnel", treatment=treatment,
