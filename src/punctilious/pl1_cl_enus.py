...
def load():
    ...
    ts.register_styledstring(tag=pl1_ts.tags.conditional, text="material implication", treatment=treatment,
        flavor=flavor, language=language)
    ts.register_styledstring(tag=pl1_ts.tags.negation, text="negation", treatment=treatment, flavor=flavor,
        language=language)
