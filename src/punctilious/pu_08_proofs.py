...
import pu_05_fundamental_connectors as _fundamental_connectors
import pu_06_interpretation as _interpretation
import pu_07_meta_language as _meta_language
...
def express_statement(v, p, c):
    ...
    return _formal_language.Formula(c=_fundamental_connectors.tuple2, a=(v, p, c,))
