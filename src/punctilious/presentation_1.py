...
class Encodings(dict):
    ...
    def __init__(self):
        ...
        super().__init__()
        self._latex_math = self._register(key='latex_math')
        self._unicode_extended = self._register(key='unicode_extended')
        self._unicode_limited = self._register(key='unicode_limited')
...
class TypesettingConfiguration:
    ...
    def typeset_as_string(self, encoding: typing.Optional[Encoding] = None, **kwargs) -> str:
        ...
        if self.typesetting_method is not None:
            ...
            raise ValueError('Not typesetting-method available')
