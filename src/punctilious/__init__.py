...
as1._connectives.transformation.formula_ts = as1.typesetters.transformation()
...
as1._connectives.inference_rule_by_transformation.formula_ts = as1.typesetters.classical_formula(
    connective_typesetter='inference-rule')
as1._connectives.inference_rule_by_algorithm.formula_ts = as1.typesetters.classical_formula(
    connective_typesetter='inference-rule')
