...
from punctilious.core import (AbsorptionDeclaration, AbsorptionInclusion, Article, AxiomDeclaration, AxiomInclusion,
    ...
    is_in_class_OBSOLETE, iterate_formula_data_model_components, is_provably_member_of_class, ModusPonensDeclaration,
    ModusPonensInclusion, ModusTollensDeclaration, ModusTollensInclusion, NameSet, NoteInclusion, Paragraph,
