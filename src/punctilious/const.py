...
# connective_hash_prime: int = 1076876232711380473
# connective_index_hash_prime: int = 3325534686958711459
# formula_hash_prime: int = 5729681708660247977
# formula_structure_hash_prime: int = 8518494684108058217
# formula_structure_terms_hash_prime: int = 3474644970855114317
