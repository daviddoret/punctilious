...
ts.register_symbol_typesetting_method(python_type=pl1.Negation, symbol=ts.symbols.not_sign,
    treatment=ts.treatments.default, flavor=ts.flavors.default, language=ts.languages.default)
ts.register_symbol_typesetting_method(python_type=pl1.MaterialImplication, symbol=ts.symbols.rightwards_arrow,
    treatment=ts.treatments.default, flavor=ts.flavors.default, language=ts.languages.default)
