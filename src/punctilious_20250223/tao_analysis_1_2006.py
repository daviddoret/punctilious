...
import punctilious_20250223.pu_03_representation as _representation
...
yaml_file_1 = _bundling.load_bundle_from_yaml_file_resource(path='punctilious_20250223.data.connectors',
                                                            resource='constants_1.yaml')
yaml_file_2 = _bundling.load_bundle_from_yaml_file_resource(path='punctilious_20250223.data.connectors',
...
def _configure_tao_interpreter():
    ...
    if _tao_interpreter is not None:
        ...
        # representations = _bundling.load_bundle_from_yaml_file_resource(path='punctilious_20250223.data.representations',
        #                                                                resource='tao_analysis_1_2006.yaml')
        mappings = _bundling.load_bundle_from_yaml_file_resource(path='punctilious_20250223.data.mappings',
                                                                 resource='tao_analysis_1_2006.yaml')
...
_statements = _bundling.load_bundle_from_yaml_file_resource(path='punctilious_20250223.data.statements',
                                                            resource='tao_analysis_1_2006.yaml')
