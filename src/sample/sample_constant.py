...
c1 = u.c.declare(value=o1, echo=True)
c2 = u.c.declare(value=o2 | r1 | o3, echo=True)

with u.with_variable(symbol='x') as x, u.with_variable('y') as y:
    c3 = u.c.declare(value=x | r1 | y, echo=True)

c4 = u.c.declare(value=o3, symbol='C', auto_index=False, echo=True)
