...
is_a = u.r.declare(arity=2, formula_rep=pu.Formula.infix, nameset=pu.NameSet('is-a'),
    signal_proposition=True)
a1d = u.declare_axiom(f'{mira_name.capitalize()} is a {dog_name}.')
a1 = t1.include_axiom(a1d)
mira_is_a_dog = t1.i.axiom_interpretation.infer_statement(a1, u.f(is_a, mira, dog))
...
with u.v('x') as x:
    ...
    if_x_is_a_dog_then_x_is_a_mammal_formula = u.f(u.relations.implies, x_is_a_dog, x_is_a_mammal)
