...
mira_is_a_dog = t1.i.axiom_interpretation.infer_formula_statement(a1, mira | u.r.is_a | dog)
...
with u.v('x') as x:
    ...
    if_x_is_a_dog_then_x_is_a_mammal = t1.i.axiom_interpretation.infer_formula_statement(a2,
    ...
    vs = t1.i.vs.infer_formula_statement(if_x_is_a_dog_then_x_is_a_mammal, mira)

    mira_is_a_mammal = t1.i.mp.infer_formula_statement(vs, mira_is_a_dog)
