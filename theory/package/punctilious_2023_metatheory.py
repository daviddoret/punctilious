...
nla_04 = ft.include_axiom(u.declare_axiom('The theory-class is the class of all package'))
...
with u.v('x') as x1, u.v('y') as x2:
    ...
    ft.commutativity_of_equality = ft.i.axiom_interpretation.infer_statement(nla_01b,
        u.f(u.r.implication, x1_equal_x2, x2_equal_x1))
...
nla_40 = ft.include_axiom(
    u.declare_axiom(natural_language='If T is a theory, and both P is valid and ¬P is valid in T, '
                                     'then this theory is an element of contradictory-package class.'))
contradictory_theories = u.o.declare('contradictory-package')
