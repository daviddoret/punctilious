...
fa_2_2_2 = t.fa(
  t.f(core.implies, t.f(is_a, n, nat), t.f(is_a, t.f(suc, n), nat)), nla_2_2_1,
  symbol='2.2.2')
...
fd_2_1_3_b = t.fd(
  t.f(core.equality, two, t.f(suc, one)), d_2_1_3, symbol='2.1.3.b')
fd_2_1_3_c = t.fd(
  t.f(core.equality, three, t.f(suc, two)), d_2_1_3, symbol='2.1.3.c')
