...
class Tao2006ThePeanoAxioms(pu.TheoryPackage):
    def develop_theory(self, t: pu.TheoryElaborationSequence) -> pu.TheoryElaborationSequence:
        ...
        t.take_note(
            content='A natural number is any element of the set N := {0,1,2,3,4, ...}, which is the set of all the numbers created by starting with 0 and then counting forward indefinitely. We call N the set of natural numbers.',
