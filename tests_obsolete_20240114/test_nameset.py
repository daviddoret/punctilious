...
class TestNameSet(TestCase):
    def test_nameset_1(self):
        ...
        self.assertEqual('𝑥₁', n.rep_symbol(encoding=pu.encodings.unicode_extended))
        self.assertEqual('𝑠𝑜𝑚𝑒𝑡ℎ𝑖𝑛𝑔-𝑝𝑟𝑒𝑐𝑖𝑠𝑒', n.rep_dashed_name(encoding=pu.encodings.unicode_extended))
        # Unicode natural language representations
        self.assertEqual('𝗌𝗆𝗍𝗁𝗇𝗀', n.rep_acronym(encoding=pu.encodings.unicode_extended))
        self.assertEqual('𝗌𝗈𝗆𝖾𝗍𝗁.', n.rep_abridged_name(encoding=pu.encodings.unicode_extended))
        self.assertEqual('𝗌𝗈𝗆𝖾𝗍𝗁𝗂𝗇𝗀', n.rep_name(encoding=pu.encodings.unicode_extended))
        self.assertEqual('𝗌𝗈𝗆𝖾𝗍𝗁𝗂𝗇𝗀 𝗉𝗋𝖾𝖼𝗂𝗌𝖾', n.rep_explicit_name(encoding=pu.encodings.unicode_extended))
        # Unicode prioritized name representations
        self.assertEqual('𝗌𝗈𝗆𝖾𝗍𝗁.', n.rep_compact_name(encoding=pu.encodings.unicode_extended))
        self.assertEqual('𝗌𝗈𝗆𝖾𝗍𝗁𝗂𝗇𝗀 𝗉𝗋𝖾𝖼𝗂𝗌𝖾', n.rep_accurate_name(encoding=pu.encodings.unicode_extended))
        self.assertEqual('𝗌𝗈𝗆𝖾𝗍𝗁𝗂𝗇𝗀', n.rep_conventional_name(encoding=pu.encodings.unicode_extended))
        # Unicode section title
        self.assertEqual('𝗻𝗼𝘁𝗲 𝟭.𝟭.𝟭 (𝑥₁) - about something',
                         n.rep_title(encoding=pu.encodings.unicode_extended))
