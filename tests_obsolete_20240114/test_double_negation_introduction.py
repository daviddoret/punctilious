...
class TestDoubleNegationIntroduction(TestCase):
    def test_dni_success(self):
        ...
        self.assertEqual('¬(¬(𝑟₁(𝑜₁, 𝑜₂)))', proposition_of_interest.rep_formula(pu.encodings.unicode_extended))
    ...
    def test_dni_failure(self):
        ...
        self.assertEqual('𝑟₁(𝑜₁, 𝑜₂)', phi1.rep_formula(encoding=pu.encodings.unicode_extended))
