...
class TestVariableSubstitution(TestCase):
    ...
    def test_variable_substitution_without_variable(self):
        ...
        self.assertEqual('𝑟₁(𝑟₂(𝑜₁, 𝑜₂))', p_prime.rep_formula(encoding=pu.encodings.unicode_extended))
    ...
    def test_variable_substitution_with_variables(self):
        ...
        with u.with_variable(symbol='x', auto_index=False) as x, u.with_variable(symbol='y',
                                                                                 auto_index=False) as y, u.with_variable(
        ...
        self.assertEqual('𝑓(𝑔(𝑔(𝐳, 𝑔(𝑓(𝐱), 𝐲)), 𝑔(𝐱, 𝐲)))',
                         p_statement.rep_formula(encoding=pu.encodings.unicode_extended))
        ...
        self.assertEqual('𝑓(𝑔(𝑔(𝑜₄, 𝑔(𝑓(𝑜₆), 𝑜₅)), 𝑔(𝑜₆, 𝑜₅)))',
                         p_prime.rep_formula(encoding=pu.encodings.unicode_extended))
