...
class TestDefinitionDeclaration(TestCase):
    ...
    def test_title(self):
        ...
        self.assertEqual('𝗗𝗲𝗳𝗶𝗻𝗶𝘁𝗶𝗼𝗻 (𝒟₁)', d1.rep_title(cap=True, encoding=pu.encodings.unicode_extended))
        self.assertEqual('𝗱𝗲𝗳𝗶𝗻𝗶𝘁𝗶𝗼𝗻 (𝒟₁)', d1.rep_title(cap=False, encoding=pu.encodings.unicode_extended))
    ...
    def test_definition_declaration(self):
        ...
        u_unicode = u.nameset.rep_symbol(encoding=pu.encodings.unicode_extended)
        ...
        self.assertEqual(
            ...
            d1.rep_report(encoding=pu.encodings.unicode_extended, wrap=False))
        self.assertEqual(
            ...
            d2.rep_report(encoding=pu.encodings.unicode_extended, wrap=False))
        self.assertEqual(
            f'𝖫𝖾𝗍 ⌜𝑏₁⌝ 𝖻𝖾 𝗍𝗁𝖾 𝑑𝑒𝑓𝑖𝑛𝑖𝑡𝑖𝑜𝑛 ⌜𝒷𝓇𝓎ℯ𝒷𝓇𝒾 𝒷𝓎𝒶𝒷𝓇𝓎ℴ𝒷ℴ𝓊 𝒷𝓊𝒷𝒾.⌝ 𝗂𝗇 {u_unicode}.',
            d3.rep_report(encoding=pu.encodings.unicode_extended, wrap=False))
        self.assertEqual(
            f'𝖫𝖾𝗍 ⌜𝑐₁⌝ 𝖻𝖾 𝗍𝗁𝖾 𝑑𝑒𝑓𝑖𝑛𝑖𝑡𝑖𝑜𝑛 ⌜𝒷𝓁ℴ𝓁ℯ 𝒷𝓁ℴ𝒿ℯ 𝒽𝓎𝓊ℊ𝓃ℯℯ.⌝ 𝗂𝗇 {u_unicode}, 𝗄𝗇𝗈𝗐𝗇 𝖺𝗌 𝗍𝗁𝖾 𝖽𝖾𝖿𝗂𝗇𝗂𝗍𝗂𝗈𝗇 𝗈𝖿 𝗍𝖾𝗌𝗍.',
            d4.rep_report(encoding=pu.encodings.unicode_extended, wrap=False))
        self.assertEqual(
            ...
            d5.rep_report(encoding=pu.encodings.unicode_extended, wrap=False))
