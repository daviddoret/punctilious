...
class TestAxiomDeclaration(TestCase):
    ...
    def test_title(self):
        ...
        self.assertEqual('𝗔𝘅𝗶𝗼𝗺 (𝒜₁)', a1.rep_title(cap=True, encoding=pu.encodings.unicode_extended))
        self.assertEqual('𝗮𝘅𝗶𝗼𝗺 (𝒜₁)', a1.rep_title(cap=False, encoding=pu.encodings.unicode_extended))
    ...
    def test_axiom_declaration(self):
        ...
        self.assertEqual(
            ...
            a1.rep_report(encoding=pu.encodings.unicode_extended, wrap=False))
        self.assertEqual(
