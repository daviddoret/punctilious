...
class TestText(TestCase):
    ...
    def test_1(self):
        ...
        self.assertEqual(pangram, compo.rep(encoding=pu.encodings.unicode_extended))
    ...
    def test_styled_text(self):
        ...
        x_unicode = x.rep(encoding=pu.encodings.unicode_extended)
        self.assertEqual(
