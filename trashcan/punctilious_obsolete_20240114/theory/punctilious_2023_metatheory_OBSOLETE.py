...
ft = u.t.register(nameset=core.NameSet(symbol='foundation-theory-1'))

axiom_01 = ft.include_axiom(u.a.register('A theory is a... (define punctilious_obsolete_20240114 data model).'))

# The (axiomatic) class of (axiomatic) classes
axiom_02 = ft.include_axiom(u.a.register('An (axiomatic) class is a collection of theoretical objects that are '
                                         'unambiguously defined by the axioms of the theory it belongs to.'))

axiom_03 = ft.include_axiom(u.a.register('The class of classes is the class of all classes defined in the '
                                         'universe-of-discourse (TODO: Or foundation theory?).'))
class_of_classes = u.o.register('class-of-classes')
element_of = u.c1.register(2, '∈', formula_rep=core.CompoundFormula.infix, signal_proposition=True,
...
nla_04 = ft.include_axiom(u.a.register('The theory-class is the class of all theory'))
theory_class = u.o.register('theory-class')
...
# Truth values
nla_05 = ft.include_axiom(u.a.register(natural_language='truth-values is the class whose elements are '
                                                        'the formulas truth and falsehood.'))
falsehood = u.o.register('false')
truth = u.o.register('true')
truth_values = u.o.register('truth-values')
...
nla_09 = ft.include_axiom(u.a.register(natural_language='propositional-connectives is the class whose elements are '
                                                        'the connectives: conjunction, disjunction, implication, and negation, '
                                                        'and any connective defined from these.'))
propositional_connectives_class = u.o.register('propositional-connectives-class')
...
nla_01b = ft.include_axiom(u.a.register('= is a binary connective such that, given any two theoretical-objcts x and y, '
...
d_55 = u.d.register('Inequality is defined as the negation of equality.')
...
nla_10 = ft.include_axiom(u.a.register('propositions is a class whose elements are '
...
proposition_class = u.o.register('proposition-class')
...
nla_20 = ft.include_axiom(u.a.register('If P is a proposition, then either the statement P has truth value true,'
                                       'or the statement P has truth value falsehood.'))
has_truth_value = u.c1.register(2, 'is', formula_rep=core.CompoundFormula.infix, signal_proposition=True)
...
nla_30 = ft.include_axiom(u.a.register('¬ is a unary connective. '
...
# DOUBLE-NEGATION
nla_09_50 = ft.include_axiom(u.a.register('If P has-truth-value t, ¬(¬(P)) has-truth-value t.'))
...
def define_conjunction():
    nla_39 = ft.include_axiom(u.a.register('If P and Q are logical propositions, '
...
def define_biconditional():
    nla = ft.include_axiom(u.a.register(natural_language='If P and Q are logical propositions, '
                                                         '(P ⇔ Q) is true if and only if '
                                                         '((P ⇒ Q) ∧ (Q ⇒ P)), '
                                                         'otherwise it is false.'))
...
nla_40 = ft.include_axiom(u.a.register(natural_language='If T is a theory, and both P is valid and ¬P is valid in T, '
                                                        'then this theory is an element of contradictory-theory class.'))
contradictory_theories = u.o.register('contradictory-theory')
contradictory_statements = u.o.register('contradictory-statement')
...
_connective_declaration = u.c1.register(2, 'connective-declaration')
_simple_objct_declaration = u.c1.register(2, 'simple-objct-declaration')
_theory_declaration = u.c1.register(2, 'theory-declaration')
_theory_extension = u.c1.register(2, 'theory-extension')
_variable_declaration = u.c1.register(2, 'variable-declaration')
...
def elaborate_foundation_theory():
    ...
    tru = u.o.register('true', capitalizable=True, python_name='tru')
    fls = u.o.register('false', capitalizable=True, python_name='fls')
    ...
    def gen1():
        ...
        subst = u.c1.register(arity=3, nameset='subst', signal_theoretical_morphism=True, implementation=substitute_xy)
