"""Punctilious: punctilious_obsolete_20240114/__init__.py
...
print(
    'Welcome to punctilious_obsolete_20240114. The library documentation is available here: https://punctilious.readthedocs.io/en/latest/')
