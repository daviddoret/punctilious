...
a1 = core.FreeTextAxiom(theory=t1, axiom_text=f'{mira_name.capitalize()} is a {dog_name}.', capitalizable=True)
mira_is_a_dog = core.FormalAxiom(theory=t1, axiom=a1, valid_proposition=core.Formula(theory=t1, relation=is_a, parameters=(mira, dog)))

a2 = core.FreeTextAxiom(theory=t1, axiom_text=f'If 𝒙 is a {dog_name}, then 𝒙 is a {mammal_name}.', capitalizable=True)
...
if_x_is_a_dog_then_x_is_a_mammal = core.FormalAxiom(theory=t1, axiom=a2, valid_proposition=if_x_is_a_dog_then_x_is_a_mammal_formula)
