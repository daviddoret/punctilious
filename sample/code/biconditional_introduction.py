...
phi1 = t1.i.axiom_interpretation.infer_statement(theory_axiom, (r1(o1, o2) | u.r.implies | r2(o3)))
phi2 = t1.i.axiom_interpretation.infer_statement(theory_axiom, (r2(o3) | u.r.implies | r1(o1, o2)))
