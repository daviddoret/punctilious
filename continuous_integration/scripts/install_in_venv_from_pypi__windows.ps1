...
Write-Output "Script: $script. Started."
...
$current_step = 1
Write-Output "Script: $script. Step: $current_step / $total_step. python -m venv $venv_name"
Invoke-Expression -Command "python -m venv $venv_name"

$current_step = 2
Write-Output "Script: $script. Step: $current_step / $total_step. $venv_name\Scripts\activate"
Invoke-Expression -Command "$venv_name\Scripts\activate"

$current_step = 3
Write-Output "Script: $script. Step: $current_step / $total_step. pip install --upgrade pip"
Invoke-Expression -Command "python -m pip install --upgrade pip"

$current_step = 4
Write-Output "Script: $script. Step: $current_step / $total_step. pip install punctilious --upgrade"
...
$current_step = 6
Write-Output "Script: $script. Step: $current_step / $total_step. Remove-Item $venv_name -Force -Recurse"
