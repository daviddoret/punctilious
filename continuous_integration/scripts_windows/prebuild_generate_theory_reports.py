"""Loop through theories natively included in the punctilious_obsolete_20240114 theory and build them for easy consultation. The idea is to progressively source an interesting library.
...
for package, filename in {
    ...
    for encoding in (pu.encodings.plaintext, pu.encodings.unicode_extended, pu.encodings.latex):
