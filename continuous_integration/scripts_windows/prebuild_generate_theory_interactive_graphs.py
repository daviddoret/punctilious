...
pu.configuration.encoding = pu.presentation_layer_1_encodings.plaintext
...
t1.export_interactive_graph(encoding=pu.presentation_layer_1_encodings.plaintext, output_path=output_path)
output_path = 'build/tao_2006_2_1_the_peano_axioms_interactive_graph_unicode.html'
t1.export_interactive_graph(encoding=pu.presentation_layer_1_encodings.unicode_extended,
