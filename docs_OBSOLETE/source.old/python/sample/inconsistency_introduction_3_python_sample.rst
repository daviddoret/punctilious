...
This page shows how to infer new statements in a theory-derivation by applying the :ref:`inconsistency-introduction-3<inconsistency_introduction_3_math_inference_rule>` :ref:`inference-rule<inference_rule_math_concept>`.
