...
class TestFormula(TestCase):
    def test_formula(self):
        ...
        r1 = u.r.declare(arity=1, formula_rep=pu.CompoundFormula.function_call)
        ...
        r2 = u.r.declare(arity=1, formula_rep=pu.CompoundFormula.prefix)
        ...
        r3 = u.r.declare(arity=1, formula_rep=pu.CompoundFormula.postfix)
        ...
        r4 = u.r.declare(arity=2, formula_rep=pu.CompoundFormula.function_call)
        ...
        r5 = u.r.declare(arity=2, formula_rep=pu.CompoundFormula.infix)
        ...
        r6 = u.r.declare(arity=3, formula_rep=pu.CompoundFormula.function_call)
        ...
        r7 = u.r.declare(formula_rep=pu.CompoundFormula.function_call)
        ...
        r8 = u.r.declare(formula_rep=pu.CompoundFormula.collection)
        ...
        r9 = u.r.declare(formula_rep=pu.CompoundFormula.collection, collection_start='{',
