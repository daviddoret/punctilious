...
class TestMT1:
    def test_mt1(self):
        ...
        c = pu.as1.is_well_formed_formula_connective(a)
        ...
        # assert pu.as1.is_formula_equivalent(phi=c, psi=d.valid_statement)
        c = pu.as1.is_well_formed_formula_connective(t)
...
class TestMT2:
    def test_mt2(self):
        ...
        c = pu.as1.is_well_formed_inference_rule_connective(i2)  # This is a formula
        m, _, d = pu.as1.derive_1(t=m, c=c, p=None, i=i, a=(i2,), raise_error_if_false=True)

        # Test 2: a simple-object is not an inference-rule
        a = pu.as1.let_x_be_a_simple_object(formula_ts='a')
        c = pu.as1.is_well_formed_inference_rule_connective(a)
        ...
        c = pu.as1.is_well_formed_inference_rule_connective(i3)  # This is a formula
...
class TestMT3:
    def test_mt3(self):
        ...
        c = pu.as1.is_well_formed_theory_connective(t)  # This is a formula
        ...
        c = pu.as1.is_well_formed_theory_connective(a)  # This is a formula
        with pytest.raises(pu.u1.ApplicativeError) as error:
            m, _, d = pu.as1.derive_1(t=m, c=c, p=None, i=i, a=(a,), raise_error_if_false=True)
...
class TestInconsistency1:
    def test_inconsistency_1(self):
        ...
        m = pu.as1.let_x_be_a_theory()  # Declare a meta-theory
        m = pu.mt1.extend_theory_with_meta_theory_1(t=m)  # Extend it with meta-theory-1 inference-rules
        c = pu.as1.is_well_formed_theory_connective(t_inconsistent)  # This is a formula
