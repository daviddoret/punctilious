...
class TestDefinition(TestCase):
    def test_definition(self):
        ...
        d1 = u.pose_definition(content1)
        d2 = u.pose_definition(content2)
        d3 = u.pose_definition(content3, header=p.ObjctHeader('1.1.1'))
        d4 = u.pose_definition(content4, header='1.1.2')
        d5 = u.pose_definition(content5, header='1.1.3', dashed_name='my-definition')
