...
class TestDefinition(TestCase):
    def test_definition(self):
        ...
        self.assertEqual(f'𝐝₁: “{content1}”', d1.repr_report(wrap=False))
        self.assertEqual(f'𝐝₂: “{content2}”', d2.repr_report(wrap=False))
        self.assertEqual(f'𝐃𝐞𝐟𝐢𝐧𝐢𝐭𝐢𝐨𝐧 𝟏.𝟏.𝟏 (d₃): “{content3}”', d3.repr_report(wrap=False))
        self.assertEqual(f'𝐃𝐞𝐟𝐢𝐧𝐢𝐭𝐢𝐨𝐧 𝟏.𝟏.𝟐 (d₄): “{content4}”', d4.repr_report(wrap=False))
        self.assertEqual(f'𝐃𝐞𝐟𝐢𝐧𝐢𝐭𝐢𝐨𝐧 𝟏.𝟏.𝟑 (d₅): “{content5}”', d5.repr_report(wrap=False))
