...
class TestPL1:
    def test_pl1(self):
        ...
        assert pu.as1.is_valid_proposition_so_far_1(p=is_a_proposition(p | land | p), t=t)
    ...
    def test_pl2(self):
        ...
        t, _, _ = pu.as1.derive_1(t=t,
                                  ...
                                  p=(
                                      ...
                                      is_a_proposition(q),),
                                  i=pu.pls1.i3, raise_error_if_false=True)
        assert pu.as1.is_valid_proposition_so_far_1(p=is_a_proposition(p | land | q), t=t)
        t, _, _ = pu.as1.derive_1(t=t,
                                  ...
                                  p=(
                                      ...
                                      is_a_proposition(p),),
                                  i=pu.pls1.i3, raise_error_if_false=True)
        assert pu.as1.is_valid_proposition_so_far_1(p=is_a_proposition(q | land | p), t=t)
    ...
    def test_pl3(self):
        ...
        t, _, _ = pu.as1.derive_1(t=t,
                                  ...
                                  p=(
                                      ...
                                      is_a_proposition(r),),
                                  i=pu.pls1.i3, raise_error_if_false=True)
        assert pu.as1.is_valid_proposition_so_far_1(p=is_a_proposition(p | land | r), t=t)
        t, _, _ = pu.as1.derive_1(t=t,
                                  ...
                                  p=(
                                      ...
                                      is_a_proposition(r),),
                                  i=pu.pls1.i3, raise_error_if_false=True)
        assert pu.as1.is_valid_proposition_so_far_1(p=is_a_proposition(q | land | r), t=t)
        t, _, _ = pu.as1.derive_1(t=t,
        ...
        assert pu.as1.is_valid_proposition_so_far_1(p=is_a_proposition(p | implies | q), t=t)
        t, _, _ = pu.as1.derive_1(t=t,
...
class TestMancosu2021P20:
    def test_mancosu_2021_page_20_with_derivation_1(self, caplog):
        ...
        t, success, _, = derive_2(c=is_a_proposition(p2 | lor | p1),
                                  i=pu.pls1.i5, t=t)
        t, success, _, = derive_2(c=is_a_proposition(p1 | implies | (p1 | lor | p2)),
                                  i=pu.pls1.i4, t=t)
    ...
    def test_mancosu_2021_page_21_with_derivation_1(self, caplog):
        ...
        t, success, _, = derive_2(c=is_a_proposition(c),
                                  i=pu.pls1.i1, t=t)
        t, success, _, = derive_2(c=is_a_proposition(d),
                                  i=pu.pls1.i1, t=t)
        t, success, _, = derive_2(c=is_a_proposition(c | implies | d),
                                  i=pu.pls1.i4, t=t)
        t, success, _, = derive_2(c=is_a_proposition(d | implies | c),
                                  i=pu.pls1.i4, t=t)
        t, success, _, = derive_2(c=is_a_proposition(d | land | d),
                                  i=pu.pls1.i3, t=t)
        t, success, _, = derive_2(c=is_a_proposition(c | land | d),
                                  i=pu.pls1.i3, t=t)
        t, success, _, = derive_2(c=is_a_proposition((d | land | d) | implies | (c | land | d)),
                                  i=pu.pls1.i4, t=t)
        # 1. ⊢ 𝐶(hypothesis)
