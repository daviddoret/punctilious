...
class TestBiconditionalIntroduction(TestCase):
    def test_biconditional_introduction(self):
        ...
        phi1 = t.i.axiom_interpretation.infer_statement(ap, u.f(u.r.implies, u.f(r1, o1, o2), u.f(r2, o3)))
        phi2 = t.i.axiom_interpretation.infer_statement(ap, u.f(u.r.implies, u.f(r2, o3), u.f(r1, o1, o2)))
