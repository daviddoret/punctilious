...
class TestInconsistencyByNegationIntroduction(TestCase):
    def test_inconsistency_introduction(self):
        ...
        t2 = u.t()
        inc = t2.i.inconsistency_by_negation_introduction.infer_statement(p=p, not_p=not_p)
    ...
    def test_inconsistency_introduction_2(self):
        ...
        with u.v() as t2_p5, u.v() as y, u.v() as z:
            t1_p3_implication = t1.i.axiom_interpretation.infer_statement(axiom=t1_a2,
                formula=u.f(u.r.implies, u.f(u.r.land, u.f(r1, t2_p5, y), u.f(r1, y, z)),
                    u.f(r1, t2_p5, z)))
        t1.stabilize()
        ...
        p9 = t1.i.inconsistency_by_negation_introduction.infer_statement(p=t2_p8, not_p=t2_p5,
