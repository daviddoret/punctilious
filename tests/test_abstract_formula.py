...
class TestAbstractFormula:
    ...
    def test_iterate_depth_first_ascending_with_index(self, af1, rgf1, af2a, rgf2b, af6a, af12a, rgf6a):
        l = tuple(t for t in af1.iterate_sequences_depth_first_ascending())
        assert l[0] == af1.restricted_growth_function_sequence
        l = tuple(t for t in af2a.iterate_sequences_depth_first_ascending())
        assert l[0] == af2a.restricted_growth_function_sequence
        assert l[1] == rgf1
        l = tuple(t for t in af6a.iterate_sequences_depth_first_ascending())
        ...
        assert l[4] == rgf1
        assert l[5] == rgf1
        l = tuple(t for t in af12a.iterate_sequences_depth_first_ascending())
