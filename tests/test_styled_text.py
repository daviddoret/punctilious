...
class TestStyledText(TestCase):
    def test_styled_text(self):
        ...
        x_plaintext = x.rep(text_format=pu.text_formats.plaintext)
        self.assertEqual(
            'The quick brown fox jumps over the lazy dog 0123456789!',
            x_plaintext)
        x_unicode = x.rep(text_format=pu.text_formats.unicode)
        self.assertEqual(
            '𝐓𝐡𝐞 𝐪𝐮𝐢𝐜𝐤 𝐛𝐫𝐨𝐰𝐧 𝐟𝐨𝐱 𝐣𝐮𝐦𝐩𝐬 𝐨𝐯𝐞𝐫 𝐭𝐡𝐞 𝐥𝐚𝐳𝐲 𝐝𝐨𝐠 𝟎𝟏𝟐𝟑𝟒𝟓𝟔𝟕𝟖𝟗!',
            x_unicode)
        x_latex_math = x.rep(text_format=pu.text_formats.latex_math)
        self.assertEqual(
        ...
        self.assertEqual(
            'The quick brown fox jumps over the lazy dog 0123456789!',
            x.rep(pu.text_formats.plaintext))
        self.assertEqual(
            'The quick brown fox jumps over the lazy dog 0123456789!',
            x.rep(pu.text_formats.unicode))
        self.assertEqual(
