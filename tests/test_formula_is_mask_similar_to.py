...
class TestFormulaIsMaskSimilarTo(TestCase):
    ...
    def test_formula_is_mask_similar_to_for_modus_ponens(self):
        ...
        phi1 = t.i.axiom_interpretation.infer_formula_statement(a=ap,
            p=u.declare_compound_formula(r1, o1, o2), lock=False)
        phi2 = t.i.axiom_interpretation.infer_formula_statement(a=ap,
            p=u.declare_compound_formula(r1, o2, o3), lock=False)
            ...
            implication = t.i.axiom_interpretation.infer_formula_statement(a=ap,
                p=u.declare_compound_formula(u.r.implies,
                    u.declare_compound_formula(u.r.land, u.declare_compound_formula(r1, x, y),
                        u.declare_compound_formula(r1, y, z)),
                    u.declare_compound_formula(r1, x, z)), lock=True)
