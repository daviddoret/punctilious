...
class TestFormula:
    def test_formula(self):
        ...
        c2 = cfl.Connector()
        c3 = cfl.Connector()
        s1 = cfl.afl.FormulaStructure(0)
        s2 = cfl.afl.FormulaStructure(1)
        s3 = cfl.afl.FormulaStructure(0, (s1,))
        s4 = cfl.afl.FormulaStructure(1, (s1, s2,))
        s4 = cfl.afl.FormulaStructure(2, (s3, s1, s2, s3, s4,))
