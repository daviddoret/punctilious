...
class TestAxiomDeclaration(TestCase):
    def test_axiom_declaration(self):
        ...
        self.assertEqual(f'Axiom declaration (o1): “{content1}”.', a1.repr_report(wrap=False))
        self.assertEqual(f'Axiom declaration (o2): “{content2}”.', a2.repr_report(wrap=False))
        self.assertEqual(f'Axiom declaration 1.1.1 (o3): “{content3}”.', a3.repr_report(wrap=False))
        self.assertEqual(f'Axiom declaration 1.1.2 (o4): “{content4}”.', a4.repr_report(wrap=False))
        self.assertEqual(f'Axiom declaration 1.1.3 (o5): “{content5}”.', a5.repr_report(wrap=False))
