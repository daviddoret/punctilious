...
class TestUniqueTuple:
    def test_1(self):
        set1 = pu.foundational_connectors.unique_tuple
        ...
        phi1 = set1(a(), b(), c())
        phi2 = pu.foundational_objects.ensure_unique_tuple(o=phi1)
        assert pu.formal_language.is_formula_equivalent(phi=phi1, psi=phi2)
        phi3 = set1(a(), b(), a())
        with pytest.raises(ValueError):
            pu.foundational_objects.ensure_unique_tuple(o=phi3)
        with pytest.raises(ValueError):
            pu.foundational_objects.UniqueExtensionTuple(a(), b(), a())
        phi4 = set1(a(), b(a()), a(b()), c(a()))
        phi5 = pu.foundational_objects.ensure_unique_tuple(o=phi4)
        assert len(phi5.arguments) == 4
        phi6 = set1()
        phi7 = pu.foundational_objects.ensure_unique_tuple(o=phi6)
...
class TestMap1:
    def test_1(self):
        ...
        m1 = pu.foundational_objects.ExtensionMap(d=domain,
                                                  c=codomain)
        ...
        m2 = pu.foundational_objects.ExtensionMap(d=domain,
                                                  c=codomain)
