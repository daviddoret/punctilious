...
class TestDoubleNegationIntroduction(TestCase):
    def test_dni(self):
        ...
        self.assertEqual(
            'r1(o1, o2)', phi1.rep_formula(encoding=pu.encodings.plaintext))
        self.assertEqual(
            '𝑟₁(𝑜₁, 𝑜₂)', phi1.rep_formula(encoding=pu.encodings.unicode))
        ...
        self.assertEqual(
            'not(not(r1(o1, o2)))', phi2.rep_formula(encoding=pu.encodings.plaintext))
        self.assertEqual(
            '¬(¬(𝑟₁(𝑜₁, 𝑜₂)))', phi2.rep_formula(encoding=pu.encodings.unicode))
        phi3 = t.i.dne.infer_statement(phi2)
        self.assertEqual(
            'r1(o1, o2)', phi3.rep_formula(encoding=pu.encodings.plaintext))
        self.assertEqual(
            '𝑟₁(𝑜₁, 𝑜₂)', phi3.rep_formula(encoding=pu.encodings.unicode))
