...
class TestUnrestrictedSequence:
    def test_data_validation(self, s10, s012, s021, s00010203043212, s00010203043262):
        assert pu.sl.data_validate_unrestricted_sequence_elements(s10) == s10
        assert pu.sl.data_validate_unrestricted_sequence_elements(s012) == s012
        assert pu.sl.data_validate_unrestricted_sequence_elements(s00010203043212) == s00010203043212
        assert pu.sl.data_validate_unrestricted_sequence_elements(s021) == s021
        assert pu.sl.data_validate_unrestricted_sequence_elements(s00010203043262) == s00010203043262

    def test_equality(self, s012, s021, s00010203043212, s00010203043262):
        assert pu.sl.UnrestrictedSequence(*s012) == pu.sl.UnrestrictedSequence(*s012)
        assert pu.sl.UnrestrictedSequence(*s00010203043212) == pu.sl.UnrestrictedSequence(
            *s00010203043212)

    def test_inequality(self, s012, s021, s00010203043212, s00010203043262):
        assert pu.sl.UnrestrictedSequence(*s012) != pu.sl.UnrestrictedSequence(
            *s00010203043212)
        assert pu.sl.UnrestrictedSequence(*s00010203043212) != pu.sl.UnrestrictedSequence(
            *s012)

    def test_cache(self, s012, s021, s00010203043212, s00010203043262):
        assert pu.sl.UnrestrictedSequence(*s012) is pu.sl.UnrestrictedSequence(*s012)
        assert pu.sl.UnrestrictedSequence(*s00010203043212) is pu.sl.UnrestrictedSequence(
            *s00010203043212)
        assert pu.sl.UnrestrictedSequence(*s012) is not pu.sl.UnrestrictedSequence(
            *s00010203043212)
        assert pu.sl.UnrestrictedSequence(
            *s00010203043212) is not pu.sl.UnrestrictedSequence(*s012)
    ...
    def test_concatenate_single(self, us0, us00, us01, us012345, us0123456789_10_11):
        assert us0.concatenate_with(us00) == pu.sl.UnrestrictedSequence(*us0, *us00)
        assert pu.sl.concatenate_flexible_unrestricted_sequences(us0123456789_10_11,
                                                                 us00) == pu.sl.UnrestrictedSequence(
