...
def graph_formula(g: nx.MultiDiGraph, f: pu.Formula):
    ...
    if f.relation.arity == 2:
        ...
        g.add_edge(f.parameters[1].repr_as_symbol(), f.repr_as_symbol())
