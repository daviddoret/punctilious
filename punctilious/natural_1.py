...
s_02 = theory_1.append_formula_statement(phi_02, core.Justification(core.axiom_encoding, axiom_1))

zero = core.ObjctObsolete(sym='0', dashed_name='zero')
phi_03 = core.Formula((core.class_membership, zero, natural_numbers))
s_03 = theory_1.append_formula_statement(phi_03, core.Justification(core.axiom_encoding, axiom_1))
